namespace BroadcastTester
{
    ...
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("BroadcastTester is running");
        ...
        public override bool OnStart()
        {
            ...
            Trace.TraceInformation("BroadcastTester has been started");
        ...
        {
            Trace.TraceInformation("BroadcastTester is stopping");
            ...
            Trace.TraceInformation("BroadcastTester has stopped");
        }
